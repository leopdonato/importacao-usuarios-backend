...
@Entity
public class UsuariosIntermediario implements Serializable {
	...
	public UsuariosIntermediario(Integer id, @NotEmpty(message = "Nome não pode ser vazio!") String nome,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UsuariosIntermediario other = (UsuariosIntermediario) obj;
